 ...
 */
$.extend({
  showReport: function (data, name1) {
    var displayName = {
      "ANTIFRAUD": "多维度反欺诈",
    ...
    function dealData(apiData,name1) {
      var resData = {};//最后的数据
