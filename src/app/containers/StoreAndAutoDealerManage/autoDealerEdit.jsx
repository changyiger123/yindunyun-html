...
class AutoDealerManageToEdit extends React.Component {
   ...
   onChange1(field, value){
	...
	var redata = {page:this.state.page};
    ...
    handleSubmit = (e) => {
	  ...
	  console.table(values);
              ajax.post("/admin/autoDealer/hq/save",values)
                  .then(response =>{
                      console.log(response);
                      if(response.code=="0"){
			this.props.router.push('/StoreAndAutoDealerManage/autodealer/'+this.state.parentpage);
                      }else{
                         // console.log("storeEdit"+response.msg);
                          message.error(response.msg);
                      }
		    ...
		    <FormItem >
		       ...
		       <FormItem label="门店：">
			      {getFieldDecorator('storeCode', {
			        initialValue:this.state.storeCode,
		      ...
		      <FormItem label="电话" hasFeedback>
			      ...
			      initialValue:this.state.autoDealerPhone,
                      ...
                      <FormItem  style={{ textAlign: "center" }}>
                          ...
                          <Button><Link to={'/StoreAndAutoDealerManage/autodealer/'+this.state.parentpage}>取消</Link></Button>
