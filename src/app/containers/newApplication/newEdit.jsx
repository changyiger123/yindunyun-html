...
class applicationEditForm extends React.Component {
    state = {
        ...
        policy:'',
        authorization:'',
       // upyunAction:'https://v0.api.upyun.com/yinmi-test',
       // upyunLinkDomain:'http://yinmi-test.b0.upaiyun.com/',
            ...
            ajax.post("/admin/autoloanApply/info", {applyNo: this.props.params.id})
                .then(response => {
                    if (response.code == "0") {
                        ...
                        var guaranteePic=data.guaranteePic;
                        ...
                        var guaranteePic2=data.guaranteePic2;
    ...
    formSave = (e) => {
            e.preventDefault();
                    ...
                    } else if(this.state.applyEmployeeCode==undefined) {
    ...
    render() {
        ...
        return (
            <div className="newApplication" style={{position: "relative"}}>
                ...
                <div id="mainCont" style={{margin: '24px 24px 20px', padding: '0 20px 60px', background: '#fff', minHeight: 780}}>
                    {/*查询选项*/}
                    <Form className="editForm" horizontal="true" onSubmit={this.handleSubmit}>
                        ...
                        <div id="info">
                            ...
                            <FormItem
                                ...
                                {getFieldDecorator("realName", {
                                    ...
                                    <Input type="text" className="ant-form-text" id="realName" name="realName"
                                           placeholder="请输入用户名/手机号"   onChange={this.onChange.bind(this, 'realName')}/>
                                )}
                            </FormItem>
                            <FormItem
                                label="性别："
                            ...
                            <FormItem
                                ...
                                wrapperCol={{span: 18}}
                            >
                                <div className="picContent clearfix cridtof" style={{overflow:"auto"}}>
                                    <Upload
                                        action={this.state.upyunAction}
                                        name="file"
                                        listType="picture-card"
                            ...
                            <FormItem
                                ...
                                {getFieldDecorator("guaranteeCardId", {
                                    ...
                                    rules: [
                                        {
                                            required: false,
                                            pattern:"(^\\d{6}(18|19|20)\\d{2}(0[1-9]|1[012])(0[1-9]|[12]\\d|3[01])\\d{3}(\\d|[xX])$|^\\d{6}\\d{2}(0[1-9]|1[012])(0[1-9]|[12]\\d|3[01])\\d{3}$)", message: "请输入正确的担保人身份证号码！"
                                        }
                                    ]
                                })(
                                ...
                                <FormItem
                                    ...
                                    {getFieldDecorator("guaranteeCardId2", {
                                        ...
                                        rules: [
                                            {
                                                required: false,
                                                pattern:"(^\\d{6}(18|19|20)\\d{2}(0[1-9]|1[012])(0[1-9]|[12]\\d|3[01])\\d{3}(\\d|[xX])$|^\\d{6}\\d{2}(0[1-9]|1[012])(0[1-9]|[12]\\d|3[01])\\d{3}$)", message: "请输入正确的第二担保人身份证号码！"
                                            }
                                        ]
                                    })(
                                ...
                                <FormItem
                                    ...
                                    {getFieldDecorator("contactRealName", {
                                        ...
                                        <Input type="text" className="ant-form-text" id="contactRealName"
                                               name="contactRealName" placeholder="请输入其他联系人一姓名（选填）"
                                ...
                                <FormItem
                                    ...
                                    {getFieldDecorator("contactRealName2", {
                                        ...
                                        <Input type="text" className="ant-form-text" id="contactRealName2"
                                               name="contactRealName2" placeholder="请输入其他联系人二姓名（选填）"
                        ...
                        <div id="orderInfo">
                            ...
                            {/* <FormItem
                                ...
                                {getFieldDecorator("dealerCode", {
                                    initialValue: formData.dealerCode,
                                    rules: [
                                        {required: true, message: "请选择车行"}
                                    ]
                                })(
                                    <Select placeholder="请选择车行" name="dealerCode" onChange={this.onChangeSelect.bind(this, 'dealerCode')}>
                                        {dealerOption}
                                    </Select>
                                )}
                            </FormItem> */}
                        ...
                        <Row className="bottom_btn" style={{width: 'calc(100% - 200px)',position:"fixed",bottom:"0"}}>
                            <Col style={{float: "left"}}>
                                <Button type="ghost" onClick={this.formRevoke} style={{background:"#FF4D4F",color:"#fff",border:"0"}} >撤销</Button>
                            </Col>
                            <Col className="rightBtn" style={{float: "right"}}>
                                <Button onClick={this.cancel_form}>取消</Button>
                                <Button type="primary" onClick={this.formSave} >保存</Button>
                ...
                <div id="floatBox">
                    ...
                    <input type="button" id="orderInfoBtn" value="订单信息"/>
