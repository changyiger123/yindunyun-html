...
class applicationForm extends React.Component {
    ...
    componentWillMount= (e) =>{
        ...
        console.log(redata);
        ajax.post("/admin/autoloanApply/first/audit/list",redata)
            .then(response =>{
                if(response.code=="0"){
    ...
    handleSubmit1 = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                ajax.post("/admin/autoloanApply/first/audit/list",data1)
                    .then(response =>{
                        if(response.code=="0"){
                            var datalist1=response.result,
                                total1=response.totalCount;
    ...
    render() {
        ...
        const columns1 = [{
            ...
            dataIndex: 'operation',
            key: 'operation',
            render: (text, record) =><Link to={'/auditList/detailOpinion2/' + record.applyNo }>审核</Link>
        }];
        const columns2 = [{
            title: '申请单号',
            dataIndex: 'applyNo',
                ...
                <Tabs defaultActiveKey="1" onChange={this.callback.bind(this)}>
                    <TabPane tab="待审核" key="1">
                        <div style={{ margin: 24,padding:'0 20px', background: '#fff', minHeight: 780 }}>
                            <Form onSubmit={this.handleSubmit1}>
                                ...
                                <FormItem label="申请状态：">
                                    <Select placeholder="请选择申请状态" onChange={this.onChangeSelect.bind(this, 'status1')}>
                                        ...
                                        <Option key="1" value="24" >待初审重审</Option>
                                    </Select>
                                </FormItem>
                                <FormItem label="门店：">
                            ...
                            <div className="ant-form-split">
                                <Table rowKey={(record) => record.applyNo} columns={columns1} dataSource={dataCont1} pagination={{
                                    simple:false,
                    ...
                    <TabPane tab="全部" key="2">
                        <div style={{ margin: 24,padding:'0 20px', background: '#fff', minHeight: 780 }}>
                            ...
                            <div className="ant-form-split">
                                <Table rowKey={(record) => record.applyNo} columns={columns2} dataSource={dataCont2} pagination={{
                                    simple:false,
