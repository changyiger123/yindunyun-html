                ...
                <div className="commonInner">
                    <div className="commonBody">
                        <div className="commonHeader">
                            ...
                            <div className="commonTitle">多维度反欺诈报告</div>
                        </div>
                        <div className="commonContent">
                            {riskData.ANTIFRAUD_INFOQUERY.MobileAndNameAndIDCheck && riskData.ANTIFRAUD_INFOQUERY.MobileAndNameAndIDCheck.mobile_three_element_consistence == 0?
                                <div className="commonCard tdType1">
                                    {riskData.ANTIFRAUD.final_decision == "REJECT"?
                                        <div className="card_left">
                                            ...
                                            <div className="card_msg">手机号三要素<span>一致</span></div>
                                        </div>
                                ...
                                :riskData.ANTIFRAUD_INFOQUERY.MobileAndNameAndIDCheck && riskData.ANTIFRAUD_INFOQUERY.MobileAndNameAndIDCheck.mobile_three_element_consistence != 0?
                                <div className="commonCard tdType2">
                                    <div className="card_title">申请用户手机号三要素不一致</div>
                                    <div className="card_result">建议不通过</div>
                                </div>
                                
                                :!riskData.ANTIFRAUD_INFOQUERY.MobileAndNameAndIDCheck&&riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.error_info?
                                <div className="commonCard tdType2">
                                    <div className="card_title">{riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.error_info}</div>
                                    <div className="card_result">建议不通过</div>
                                </div>
                                :riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_consistence&&riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_consistence!=0?
                                <div className="commonCard tdType2">
                                    <div className="card_title">申请用户存在公安不良记录</div>
                                    <div className="card_result">建议不通过</div>
                                </div>
                                :''
                            }
                            ...
                            <div className="commonMainType1">
                                {riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.error_info?
                                ''
                                :
                                <div className="commonItem">
                                    <h3><img src={report_titleIcon} alt="icon" />自然人识别</h3>
                                    <div className="commonTable1">
                                        <div className="commonTheader">
                                            <div className="commonTh">公安不良记录犯罪描述</div>
                                            <div className="commonTh">公安不良记录犯罪状态</div>
                                        </div>
                                        <div className="commonTbody">
                                            <div className="commonTr">
                                                <div className="commonTd">{riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_msg=="未比中"?"无记录":riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_msg}</div>
                                                <div className="commonTd">{riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_status==0?'无记录':riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_status==1?'比中在逃':riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_status==2?'比中前科':riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_status==3?'比中涉毒':riskData.ANTIFRAUD_INFOQUERY.CriminalInfo.police_message.police_criminal_status==4?'比中吸毒':'其他'}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>}
                                {riskData.ANTIFRAUD_INFOQUERY.MobileDuration?
                                <div className="commonItem">
                                    <h3><img src={report_titleIcon} alt="icon" />手机号在网时长信息</h3>
                                    <div className="commonTable5">
                                        <div className="commonTbody">
                                            <div className="commonListName">手机号在网时长</div>
                                            <div className="commonListMsg">{riskData.ANTIFRAUD_INFOQUERY.MobileDuration.mobile_online_time_consistence=='0'?riskData.ANTIFRAUD_INFOQUERY.MobileDuration.mobile_online_time_info:'库无记录'}</div>
                                        </div>
                                    </div>
                                </div>:''}
